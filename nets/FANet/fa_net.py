...
from nets.FANet.resnet import Resnet18, Resnet34, Resnet50, Resnet101, Resnet152
...
class ConvBNReLU(nn.Module):
    def __init__(self, in_chan, out_chan, ks=3, stride=1, padding=1, norm_layer=None, activation='leaky_relu', *args,
                 **kwargs):
...
if __name__ == '__main__':
    ...
    model = FANet(4, backbone='resnet18')
    model = FANet(4, backbone='resnet34')
    output = model(img)
