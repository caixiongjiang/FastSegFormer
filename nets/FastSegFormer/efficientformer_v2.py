...
@register_model
def efficientformerv2_s0_feat(pretrained=False, **kwargs):
...
@register_model
def efficientformerv2_s1_feat(pretrained=False, **kwargs):
    model = EfficientFormerV2(
...
@register_model
def efficientformerv2_s2_feat(pretrained=False, **kwargs):
    model = EfficientFormerV2(
...
@register_model
def efficientformerv2_l_feat(pretrained=False, **kwargs):
    model = EfficientFormerV2(
